    ...
    >
      <div className="container-custom flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button 
            className="bg-sarya-green/90 hover:bg-sarya-purple hover:scale-105 text-white dark:bg-sarya-green/80 dark:hover:bg-sarya-purple font-bold px-3 py-1.5 h-auto text-sm md:text-base dark:text-sm rounded-full shadow-lg transition-all duration-300"
          >
